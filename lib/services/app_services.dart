...
import '../di/donation/donation_di.dart';
...
class AppServices {
  ...
  StripeRepository get stripeRepository => getIt<StripeRepository>();
  DonationController get donationController => getIt<DonationController>();
}
